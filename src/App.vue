<template>
  <v-app>
    <h1
      class="display-3 mt-10 text-center"
      style="font-family: sans-serif !important;"
    >
      Get your
      <a href="https://web.facebook.com/groups/launchamericanasasocial"
        >#NASASocial</a
      >
      Badge
    </h1>
        ...
        <v-form>
          <v-container>
            ...
            <v-row>
              <p class="mt-12">
                Made with ❤️ by
                <a href="https://twitter.com/iSarmadGulzar">Sarmad Gulzar</a> on
                <a
                  class="btn-octicon"
                  href="https://github.com/sarmadgulzar/nasa-social-badge"
                >
                  <svg
